...
* Azul Zulu JDK: 11 (11.0.5u10+), 17 (17.0.2+)
* Oracle JDK: 11 (11.0.5u10+), 17 (17.0.2+)
* Amazon Corretto: 11 (11.0.5+), 17 (17.0.2+)
* Adopt Open JDK: 11 (11.0.5+), 17 (17.0.2+)
* Adopt Open JDK with Eclipse Open J9: 11 (11.0.5+), 17 (17.0.2+)
* Any other JVM based on OpenJDK 11.0.5+ or 17.0.2+
